    ...
    >
      <Wrapper classname="h-[60px] flex z-20 justify-between items-center">
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          <Link href="/cart">
            <div className="w-8 md:w-12 h-8 md:yh-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative">
          ...
          <div>
            {session ? (
              ...
              <>
                <button
                  className="border border-gray-950 hover:text-white hover:bg-gray-950  px-3 py-1 rounded"
                  onClick={() => signIn()}
                >
                  Register
                </button>
          ...
          <div
            className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center
               hover:bg-black/[0.05] cursor-pointer realtive -mr-2 md:hidden"
          >
            {mobileMenu ? (
              <VscChromeClose
                className="text-[16px] "
